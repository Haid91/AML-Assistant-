    ...
    <div className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-white font-sans">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-16 pb-12">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-10 leading-relaxed">
          This policy covers how AmlIntel handles personal information about <em>you</em>, as a user of this site.
        ...
        <div className="space-y-10 text-slate-600 dark:text-slate-300 leading-relaxed text-sm">
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc pl-5">
              <li><strong>Anthropic</strong> — the AI provider that generates chat responses and drafted documents. Relevant business details and conversation content are sent to Anthropic's API to generate a response.</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">5. Data retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">6. Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">7. Your rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">8. Children's privacy</h2>
            <p>AmlIntel is a business compliance tool and isn't intended for use by children.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">9. Changes to this policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">10. Contact</h2>
            <p>
