      ...
      <div className="bg-violet-950/70 border-b border-violet-800/40">
        <div className="max-w-6xl mx-auto px-6">
          <button
            ...
            className="w-full py-2 flex items-center gap-2 text-left"
          >
            ...
            <svg
              className={`w-3.5 h-3.5 text-violet-400 shrink-0 transition-transform duration-200 ${camsOpen ? 'rotate-180' : ''}`}
              fill="none" stroke="currentColor" viewBox="0 0 24 24"
            >
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
            </svg>
          ...
          {camsOpen && (
            <div className="pb-4 pt-1 grid sm:grid-cols-2 gap-x-12 gap-y-1.5">
              {[
                '80 exam-style MCQs across 4 ACAMS chapters',
