                ...
                <div className="flex items-center justify-end gap-3">
                  {locked ? (
                    <>
                      ...
                      <button className="flex items-center gap-1.5 px-4 py-2 bg-blue-600 text-white rounded-full text-xs font-semibold">
        ...
        {!isPremium && (
          <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-6">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <button className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-full font-semibold text-sm transition-colors">
